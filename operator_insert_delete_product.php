                    ...
                    if(!$result2)
                        {
                            ...
                            if(!$result7)
                            {
                                ...
                                header("Location: operator_insert_delete_product.php");
		                        die;
                            }
                        }
                }
            ...
            while($row = $result->fetch_assoc()) {
                echo   '<tr>
                     ...
                     echo  '<td> '.$p_data["prooduct_description"].'</td>
                            ...
                            <td><a href="operator_update.php/?p_id='.$abc.'" ><input id="button" value="         Update"></td>
                            <td><a href="operator_purchase_product.php/?p_id='.$abc.'"><input id="button" value=" Purchase Product"></a></td>
                        </tr>';
            }
        }
    echo'</table>
