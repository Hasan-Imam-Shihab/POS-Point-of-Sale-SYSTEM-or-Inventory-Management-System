                ...
                while($row = $result->fetch_assoc()) {
                    echo   '<tr>
                     ...
                     echo  '<td> '.$p_data["prooduct_description"].'</td>
                        ...
                        echo'<td><a href="operator_add.php/?id='.$row["id"].'" onclick="location.href=this.href+ &#39&xyz=&#39 +data1;return false;"><input id="button" value="         ADD"></td>
                        </tr>';
            }
        }
    echo'</table>
            </p>
                <a href="operator_interface.php"><input id="button" value="         Back"></a>';
    ?>
                <div id='parent' style="background-color: white; left: 58%; top: 20%;width: 40%;">
                    ...
                    <p style='font-size: 20px; color:black;'>Transaction Id: <?php echo $tid; ?></p>
                            ...
                            {   
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    if($result3 && mysqli_num_rows($result3) > 0)
                                        ...
                                        echo'<td><a href="operator_delete.php/?id='.$prd_id.'">delete</a></td></tr>';
                                }
                            }
                        ?>
                    ...
                    <p style='font-size: 12px; color:black; text-align: left;'>Total: <?php echo $total; ?></p>
                ...
                <?php
                echo '<a href="operator_complete.php/?t_id='.$tid.' "><input type="button" id="button" value="Print" onclick="myApp.printDiv()" /></a>';
                ?>
            </div>
		</form>
	</body>
